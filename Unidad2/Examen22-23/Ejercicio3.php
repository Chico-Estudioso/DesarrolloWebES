...
<body>
    <form action="" method="post">
        ...
        <div>
            ...
            <input type="checkbox" name="opciones[]" value="Cuna"
                <?php if (isset($_POST['opciones']) && in_array('Cuna', $_POST['opciones'])) echo 'checked'; ?> />Cuna
            <input type="checkbox" name="opciones[]" value="Cama Supletoria"
                <?php if (isset($_POST['opciones']) && in_array('Cama Supletoria', $_POST['opciones'])) echo 'checked'; ?> />Cama
            Supletoria
            <input type="checkbox" name="opciones[]" value="Lavandería"
                <?php if (isset($_POST['opciones']) && in_array('Lavandería', $_POST['opciones'])) echo 'checked'; ?> />Lavandería
        </div>
        <br />
        <div>
