...
<body>
    ...
    if (isset($_POST['crear'])) {
        ...
        if (
            empty($_POST['fecha']) or empty($_POST['hora']) or empty($_POST['nombre'])
    ...
    <table width="50%" align="center">
        ...
        foreach ($citas as $c) {
            ...
            echo '<td>' . $c->getTipoServicio() . '</td>';
            echo '<td>' . $c->getNombreServicio() . '</td>';
            echo '<td>' . strtotime('1970-01-01'.$c->get)+($c->obtenerTiempoServicio()) . '</td>';
            echo '</tr>';
        }
        ?>
    </table>
